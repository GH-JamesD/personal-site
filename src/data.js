export const pastWork= [
    ...
    description: "Matrix to dendrogram is a program that uses computational methods to visualize relationships among RNA structural conformations written in Perl. This was accomplished by taking data from large matrices (20,000+ entries) of simulated molecular dynamics data and visualizing them as dendrograms using agglomerative hierarchical clustering. Work using this program has been submitted for publication.",
