        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "With a background in biochemistry and biomedical research, I started at UC Berkeley as a chemical biology major in fall 2020. After taking my first computer science class in spring 2021, I fell in love with the discipline and switched my major by fall. In the past I have taught introductory CS and discrete math, and am now a TA for an upper division algorithms course. I am particularly passionate about optimization, from algorithms all the way down to optimizing hardware at the transistor level. In my free time I enjoy cooking, baking, weightlifting, going to concerts, and building PC computers."
            ),
            React.createElement(
              "div",
